...
object NavRoutes {
    ...
    const val STUDENT_SIGN_IN_SCREEN = "student_sign_in_screen"  // ✅ Add this
    const val COMPANY_SIGN_IN_SCREEN = "company_sign_in_screen"  // ✅ Add this
    const val STUDENT_HOME_SCREEN = "student_home_screen"
    const val COMPANY_HOME = "company_home_screen"
